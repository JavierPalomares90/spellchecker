...
def load_bigram_dictionary(master_list_text,separator):
    dictionary = dict()
...
def build_bigram_dictionary(master_list,save_path):
    ...
    with open(master_list, 'r', encoding="utf-8") as master_list_text:
        dictionary,frequency_count = load_bigram_dictionary(master_list_text, ' ')
...
def main():
    ...
    build_bigram_dictionary(master_list,save_path)
